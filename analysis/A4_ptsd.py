...
# Load parquet file
# -----------------------------
file_path = "PTSD_reddit_detoxified.parquet"
...
plt.title("Top 10 PTSD Subreddits - Old Toxicity")
...
plt.ylabel("Subreddit")
plt.title("Top 10 PTSD Subreddits - New Toxicity")
plt.gca().invert_yaxis()
plt.tight_layout()
plt.show()
...
plt.ylabel("Subreddit")
plt.title("Top 10 PTSD Subreddits - Toxicity Reduction")
plt.gca().invert_yaxis()
plt.tight_layout()
plt.show()
...
# Save results
# -----------------------------
top10.to_csv("top10_ptsd_subreddit_toxicity_analysis.csv", index=False)
