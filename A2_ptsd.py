"""
A2: Per-Comment Chain Average % Toxic (PTSD Dataset)
======================================================
"""
...
# ─────────────────────────────────────────────────────────────
CONFIG = {
    "input_file": "PTSD_reddit_detoxified.parquet",  # ✅ UPDATED
...
def compute_by_subreddit(chains):
...
def plot(chains, overall, out_dir):
    ...
    plt.title("Distribution of Toxic % per Chain (PTSD Dataset)")
    plt.xlabel("Toxic % per Chain")
...
# ─────────────────────────────────────────────────────────────
def run(cfg):
    print("\nRunning A2 PTSD Toxicity Analysis...\n")
    ...
    by_sub = compute_by_subreddit(chains)
